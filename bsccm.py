...
class BSCCM:
    ...
    def get_corrected_fluor(self, indices):
        ...
        return self.surface_marker_dataframe.iloc[indices][names].to_numpy()
    ...
    def get_surface_marker_data(self, indices):
        ...
        four_spectra_data = self.surface_marker_dataframe.iloc[indices][four_spectra_model_names].to_numpy()
        two_spectra_data = self.surface_marker_dataframe.iloc[indices][two_spectra_model_names].to_numpy()
